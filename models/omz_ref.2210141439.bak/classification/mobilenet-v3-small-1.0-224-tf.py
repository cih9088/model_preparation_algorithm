# https://github.com/openvinotoolkit/open_model_zoo/tree/master/models/public/mobilenet-v3-small-1.0-224-tf
...
model = dict(
    ...
    backbone=dict(
        type="MMOVBackbone",
        model_path="public/mobilenet-v3-small-1.0-224-tf/FP32/mobilenet-v3-small-1.0-224-tf.xml",
