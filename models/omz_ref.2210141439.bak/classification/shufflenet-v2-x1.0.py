# https://github.com/openvinotoolkit/open_model_zoo/tree/master/models/public/shufflenet-v2-x1.0
...
model = dict(
    ...
    backbone=dict(
        type="MMOVBackbone",
        model_path="public/shufflenet-v2-x1.0/FP32/shufflenet-v2-x1.0.xml",
