# https://github.com/openvinotoolkit/open_model_zoo/tree/master/models/public/mobilenet-v2-1.0-224
...
model = dict(
    ...
    backbone=dict(
        type="MMOVBackbone",
        model_path="public/mobilenet-v2-1.0-224/FP32/mobilenet-v2-1.0-224.xml",
