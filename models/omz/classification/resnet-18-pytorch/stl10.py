# https://github.com/openvinotoolkit/open_model_zoo/tree/master/models/public/resnet-18-pytorch
...
model = dict(
    ...
    backbone=dict(
        type="MMOVBackbone",
        model_path="public/resnet-18-pytorch/FP32/resnet-18-pytorch.xml",
