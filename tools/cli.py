...
from mpa import det
from mpa import seg
from mpa.modules.datasets.pipelines.transforms.resize import Resize
from mpa.modules.datasets.imagenet import ImageNet
from mpa.modules.datasets.coco import CocoDataset
#  from mpa import seg
from mpa_tasks import utils
...
def main(args):
    ...
    if isinstance(recipe, Stage):
        recipe.run(
            ...
            model_cfg=model_cfg,
            data_cfg=data_cfg,
            ir_model_path=args.ir_path,
            ir_weight_init=args.init,
